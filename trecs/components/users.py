...
class DNUsers(Users):
    ...
    def get_user_feedback(self, *args, **kwargs):
        ...
        if items_shown is None:
            raise ValueError("Items can't be None")
        reshaped_user_vector = self.user_vector.reshape((items_shown.shape[0], 1))
        item_utilities = self.divisive_normalization_utilities()
        user_interactions = item_utilities[reshaped_user_vector, items_shown]
    ...
    def divisive_normalization_utilities(self):
        """
